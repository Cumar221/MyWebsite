                ...
                <div className="container-fluid">
                    <div className="row no-gutter">
                        <div className="col-lg-6 col-sm-6" style={{margin: '0 auto', paddingTop: '20px', paddingLeft: '10px', paddingRight: '10px', color: 'black'}}>
                            ...
                            <p>	Hey you, nice to meet you and welcome to my website. My name is Cumar Yusuf and I currently reside
                            ...
                            <p>	I've dabbled in developing mobile apps on iOS, Android and Windows. I've developed Desktop applications
                                in C# and Java. I've developed some web applications including this one. I've build tangible firmware devices using a Raspberry Pi, input and output sensors
                            ...
                            <p>	On a personal level, I'm a quiet humble chill person who doesn't wine or complain about small stuff.
                                ...
                                to be better. I love haters and people who love talking smack as it fuels my engine and gets me going.
                                I love the challenges this world has to offer and it teaches me to be stronger and resilient. I love to
                                travel and see how the world is, to see how people live and interact in their society, to learn from
                                other cultures and to of course not be entrapped in a box listening to fake news.
                            </p>
                        </div>
                    </div>
                </div>
